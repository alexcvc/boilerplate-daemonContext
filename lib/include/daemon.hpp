...
class Daemon {
 public:
   ...
   * @param func The function to be called.
   */
  void setReloadFunction(std::function<std::optional<bool>()> func) {
   ...
   * @param func The function to be called.
   */
  void setUser1Function(std::function<std::optional<bool>()> func) {
   ...
   * @param func The function to be called.
   */
  void setUser2Function(std::function<std::optional<bool>()> func) {
   ...
   * @param func The function to be called.
   */
  void setCloseFunction(std::function<std::optional<bool>()> func) {
   ...
   */
  std::optional<bool> makeDaemon(const std::string& pidFileName);
